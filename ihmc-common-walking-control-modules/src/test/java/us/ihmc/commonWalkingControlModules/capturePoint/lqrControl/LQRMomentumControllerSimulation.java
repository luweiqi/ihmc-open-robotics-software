...
public class LQRMomentumControllerSimulation
{
   ...
   public LQRMomentumControllerSimulation()
   {
      ...
      if (include1)
      {
         ...
         dcmPlan.setCornerPointViewer(new CornerPointViewer(sphereRobot1.getScsRobot().getRobotsYoVariableRegistry(),
      ...
      if (include2)
      {
         ...
         dcmPlan.setCornerPointViewer(new CornerPointViewer(sphereRobot2.getScsRobot().getRobotsYoVariableRegistry(),
