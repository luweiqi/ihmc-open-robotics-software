...
public class ValkyrieFootstepPlannerTest
{
   @Test
   ...
   private void testDataSet(DataSetName dataSetName, double timeout)
   {
      ...
      ValkyrieFootstepPlanner planner = new ValkyrieFootstepPlanner(robotModel);
      ...
      SimplePlanarRegionFootstepNodeSnapper snapper = new SimplePlanarRegionFootstepNodeSnapper(ValkyrieFootstepPlanner.createFootPolygons(robotModel));
